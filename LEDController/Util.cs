...
public static class Debug
{
    ...
    public struct LogMessage
    {
        ...
        public LogMessage(string prefix, object message, ConsoleColor color)
        {
            this.prefix = prefix;
    ...
    public static void Log(object data, ConsoleColor color = ConsoleColor.White, bool newLine = true, string prefix = "DEBUG")
    {
        ...
        if (newLine)
        {
            ...
            messages.Add(new LogMessage(prefix, data, color));
        ...
        else
        {
            ...
            {
                //log[log.Count - 1].message += data;
                LogMessage msg = messages[messages.Count - 1];
    ...
    public static void LogWarning(object data, bool newLine = true)
    {
        ...
        Console.ForegroundColor = originalColor;*/
        Log(data, ConsoleColor.Yellow, newLine, "WARNING");
    }
    ...
    public static void LogError(object data, bool newLine = true)
    {
        ...
        Console.ForegroundColor = originalColor;*/
        Log(data, ConsoleColor.Red, newLine, "ERROR");
    }
    ...
    public static void FatalError(object data, int exitCode = 0, int sleepTime = 0)
    {
        ...
        //LogError("\n\n\n\n" + "FATAL ERROR:\n" + data);
        Log("\n\n\n\nFATAL ERROR:\n" + data.ToString(), ConsoleColor.Red, true, "FATAL ERROR");
        MessageBox.Show(data.ToString(), "Fatal error", MessageBoxButton.OK, MessageBoxImage.Error);

        //viewer.Close();
        Controller.LogViewer viewer = new Controller.LogViewer();
        viewer.ShowDialog();
    ...
    public static void Exception(Exception e, string prefix = "")
    {
        ...
        Log(e.Message, ConsoleColor.Red, true, prefix);
        //LogError(e.StackTrace);
        Log(e.StackTrace, ConsoleColor.DarkRed, true, "STACK TRACE");
